    ...
    <Container maxWidth="md">
      ...
      <Grid>
        ...
        <Typography variant="body1" paragraph={true}>
          ...
          and may be stored by&nbsp;JN Projects, Inc., d.b.a. HelloSign
        ...
        <Typography variant="body1" paragraph={true}>
          ...
          about the Personal Information we disclosed to third parties for
          ...
          an e-mail to [insert email address] or write to us at [insert mailing
          address]. Not all information sharing is covered by the “Shine the
