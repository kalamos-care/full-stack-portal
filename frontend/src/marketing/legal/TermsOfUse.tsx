            ...
            <Typography variant="body1">
              ...
              <li>
                ...
                <Typography variant="body1" paragraph>
                  ...
                  You agree that we maytransferyour credit card
              ...
              <li>
                <b>Refund Policy</b>
                <Typography variant="body1" paragraph>
                  Anyrefundsprovided under thispolicywill
                  ...
                  charged upfront when you purchasethe Services.
              </Typography>
              </li>
              <li>
              ...
              <li>
                ...
                <Typography variant="body1" paragraph>
                  ...
                  including without limitation, any content posted to ortransmitted through the Services, or publicly distributed on the web, your use of the Services, your connection to the Services, your violation of the Terms of Use or applicable law or your violation of any rights of another.
              </Typography>
              </li>
              <li>
                <b>International</b>
                <Typography variant="body1" paragraph>
                  We make no representation that information provided by the Services is appropriate or available for use outside the United States. Those who choose to access the Services from outside the United States do so on their own initiative and at their own risk and are responsible for compliance with all applicable laws and regulations. By using the Services, you consent to having any information you provide to us transferred to and processed in the United States.
              </Typography>
              </li>
              <li>
